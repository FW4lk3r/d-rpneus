      ...
      <div class="modal fade" id="modal-pneu">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="<?= base_url('admin/criarPneu');?>" method="POST" class="form-horizontal">
                  <div class="form-group">
                    <label for="inputName" name="pneu" class="col-sm-2 control-label">Nome </label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="marca" id="inputName" placeholder="Nome pneu">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="marca" id="inputName" placeholder="Preço">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" style="width: 100%;">
                            ...
                            { ?>
                                <option id="<?= $row->id_marca ?>"><?= $row->marca ?></option>
                            <?php } ?>
                        </select>
                    </div>
                  </div>  
