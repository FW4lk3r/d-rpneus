                    ...
                    {  ?>
                        ...
                        <tr>
                            ...
                            <td style=" vertical-align: middle!important;">
                                ...
                                <a href="editarPneu/<?= $row->id_pneu ?>"> <button class="btn btn-warning">Editar</button> 
                                <a href="deletePneu/<?= $row->id_pneu ?>" onclick="return confirm('Tem a certeza que deseja eliminar este pneu?');"><button class="btn btn-danger">Apagar</button></a>
                            </td>
                        </tr>
                   <?php }?>
